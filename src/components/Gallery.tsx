...
const images: GalleryImage[] = [
  { src: 'https://images.unsplash.com/photo-1629909615184-74f495363b67?auto=format&fit=crop&w=800&q=80', alt: 'Dr Joao Pires especialista', caption: 'Especialista em Itaquera' },
  { src: 'https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?auto=format&fit=crop&w=800&q=80', alt: 'Equipe profissional', caption: 'Equipe de Confianca' },
  { src: 'https://images.unsplash.com/photo-1588776814546-1ffcf47267a5?auto=format&fit=crop&w=800&q=80', alt: 'Tratamento especializado', caption: 'Tratamento Especializado' },
  ...
  { src: 'https://images.unsplash.com/photo-1571772996211-2f02c9727629?auto=format&fit=crop&w=800&q=80', alt: 'Cuidado com excelencia', caption: 'Excelencia no Cuidado' },
];
